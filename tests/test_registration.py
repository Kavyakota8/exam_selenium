...
def test_empty_username(setup_teardown):
    ...
    driver.find_element(By.NAME, "pwd").send_keys("kavya123")
...
def test_empty_password(setup_teardown):
    ...
    driver.find_element(By.NAME, "username").send_keys("kavya")
...
def test_short_password(setup_teardown):
    ...
    driver.find_element(By.NAME, "username").send_keys("kavya")
    driver.find_element(By.NAME, "pwd").send_keys("kav")
    driver.find_element(By.NAME, "sb").click()
...
def test_valid_input(setup_teardown):
    ...
    assert "Hello, kavya! Welcome to the website" in body_text, f"Greeting not found or incorrect: {body_text}"